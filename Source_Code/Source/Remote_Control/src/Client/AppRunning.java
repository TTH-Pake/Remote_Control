...
public class AppRunning extends javax.swing.JDialog {

    Socket sending = null;
    DataOutputStream dataOutput = null;
    DataInputStream dataInput = null;
    private EndApp endTask = null;
    private StartApp  startTask = null;
    DefaultTableModel model;
   
        public AppRunning(JFrame owner, boolean modal, Socket socket) throws IOException{
        super(owner, modal);
        sending = socket;
    ...
    private void initComponents() {
        ...
        StartTask.setText("Start App");
        StartTask.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                StartTaskActionPerformed(evt);
            }
        });
        jPanel1.add(StartTask, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 13, -1, -1));
        ...
        EndTask.setText("End App");
        EndTask.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EndTaskActionPerformed(evt);
            }
        });
        jPanel1.add(EndTask, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 13, 82, -1));
        ...
        jPanel1.add(Load, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 13, 87, -1));
        ...
        jPanel1.add(Reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(329, 13, 92, -1));
    ...
    private void StartTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartTaskActionPerformed
        try {
            ...
            startTask = new StartApp(this, true, sending);
            startTask.setTitle("Start app");
    ...
    private void EndTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EndTaskActionPerformed
        try {
            ...
            endTask = new EndApp(this, true, sending);
            endTask.setTitle("End app");
    ...
    private void LoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoadActionPerformed
        ...
        try {
            ...
            dataOutput.writeUTF("Load app running");
            dataOutput.flush();
            ...
            while(!"".equals(temp))
            {
                app = temp.substring(1, (temp.length()-1)).split("\",\"");
                model = (DefaultTableModel) txtTable.getModel();
                model.addRow(new Object[]{app[0], app[1], app[2], app[3], app[4]});
    ...
    private javax.swing.JButton StartTask;
