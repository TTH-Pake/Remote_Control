...
public class End extends JDialog {
    ...
    public End(JDialog owner, boolean modal, Socket socket) throws IOException{
        super(owner, modal);
        sending = socket;
    ...
    private void initComponents() {
        ...
        btnEndtask.setText("END");
        btnEndtask.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnEndtask.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEndtaskActionPerformed(evt);
            }
        });
        getContentPane().add(btnEndtask, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 30, 60, 30));
        btnEndtask.getAccessibleContext().setAccessibleName("");

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 255, 255));
        jLabel2.setText("  KILL ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, 50, -1));
    ...
    private void btnEndtaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEndtaskActionPerformed
        ...
        try {
            dataOutput.writeUTF("Kill process");
            dataOutput.flush();            
